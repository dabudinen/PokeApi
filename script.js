...
const renderPokemonStats = stats => {
    ...
    stats.forEach(element =>{
        ...
        statElementName.textContent = element.stat.name;
        statElementAmount.textContent = element.base_stat
...
const renderNotFound = () => {
    ...
    pokeImg.setAttribute('src','misigno.webp')
    pokeImg.setAttribute('height','150px')
    pokeImg.setAttribute('width','150px')
